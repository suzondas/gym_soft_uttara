...
Class GymAjaxController extends AppController
{
	...
	{	$this->loadComponent("GYMFunction");
		...
		<div class="form-group">
			<label class="col-sm-3 control-label" for="amount"><?php echo __("Memo Number");?><span class="text-danger">*</span></label>
			<div class="col-sm-8">
				<div class='input-group'>
					<span class='input-group-addon'>#</span>
					<input id="memo" class="form-control validate[required] text-input" type="text" value="" name="memo_no">
				</div>
			</div>
		</div>
	...
	public function getAmountByMemberships()
	{
		if($this->request->is('ajax'))
		{
			...
			$row = $mem_tbl->get($mid,['contain'=>['Discount_Id']])->toArray();
			...
			<tbody>
				...
				<tr>
					...
					<td valign="top" align="<?php echo $float_r;?>">
						...
						echo "<br>Mobile: <h4>".$data[0]["gym_member"]["mobile"]."</h4><br>";
						?>
					</td>
				</tr>
			</tbody>
		...
		<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
			<thead>
				<tr>
					...
					<th class="text-center"> <?php echo __('Discounted Fee');?></th>
			...
			<!-- <td class="text-center"><?php echo $this->GYMFunction->get_currency_symbol();?> <?php echo $data[0]["membership"]["signup_fee"];?></td> -->
				...
				<td class="text-center"><?php echo $this->GYMFunction->get_currency_symbol();?> <?php echo $data[0]["discount_amount"];?></td>
				<td class="text-center"><?php echo $this->GYMFunction->get_currency_symbol();?> <?php echo $subtotal = intval($data[0]["discount_amount"]) /* + intval($data[0]["membership"]["signup_fee"]);*/ ?></td>
			</tbody>
		</table>
		<table width="100%" border="0">
			<tbody>
		...
		<thead>
			...
			<tbody>
				...
				{?>
					...
					<td class="text-center"><?php echo $retrive_date["memo_no"];?></td>
					</tr>
		  <?php }?>
			</tbody>
		</table>
