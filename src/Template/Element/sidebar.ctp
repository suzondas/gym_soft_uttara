     ...
     <!-- <form action="#" method="get" class="sidebar-form">
          ...
          <!-- <li class="header">MAIN NAVIGATION</li> -->
			...
			<li class="treeview <?php echo ($this->request->controller == "GymGroup") ? "active" : "";?>">
              ...
              <li class="treeview <?php echo ($this->request->controller == "Corporate") ? "active" : "";?>">
                  <a href="<?php echo $this->Gym->createurl("Corporate","CorporateList");?>">
                      <i class="fa fa-id-card"></i> <span><?php echo __('Corporate');?></span>
                  </a>
              </li>
